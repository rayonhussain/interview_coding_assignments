# Roof Coding Assessment

## SQL Coding

- Q. In the text box below, provide January 31's rolling 3 day average of total transaction amount processed per day
- A. 59.43 

### Code Snippet used:

```sql /* Using this dataset, show the SQL query to find the rolling 3 day average transaction amount for each day in January 2021. */
with sql_temp as 
	(select 
...
| transaction_date | rolling_3day_avg_amt |
| ---------------- | -------------------- |
| 2021-01-31       | 59.43                |
